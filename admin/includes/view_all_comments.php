        ...
        <tbody>
            ...
            <?php
                    ...
                    while($row = mysqli_fetch_assoc($select_comments))
                    {
                        ...
                        $comment_conetnt    = $row['comment_content'];                                              
                        ...
                        echo "<td>$comment_conetnt</td>";


                        // $query = "SELECT * FROM comment WHERE cat_id = {$post_category_id}";
...
if(isset($_GET['unapproved']))
{
    ...
    $unapproved_comment_query = mysqli_query($connect,$query);
