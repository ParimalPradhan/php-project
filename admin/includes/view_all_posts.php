        ...
        <tbody>
            ...
            <?php
                    ...
                    while($row = mysqli_fetch_assoc($select_posts))
                    {
                        ...
                        // echo "<td><img class='img-responsive tbl-img' src='../images/$post_image' alt='this is image niga'></td>";
                        echo "<td><img width='100' src='../images/$post_image' alt='this is image niga'></td>";
...
if(isset($_GET['reset']))
{
    ...
    $query = "UPDATE posts SET post_view_count = 0 WHERE post_id =" . mysqli_real_escape_string($connect, $_GET['reset']) . " ";
