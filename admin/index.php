<?php include "includes/admin_header.php"?>
    ...
    <div class="col-lg-3 col-md-6">
        ...
        <?php
            ...
            $select_all_active_post = mysqli_query($connect,$query);
            $all_active_post = mysqli_num_rows($select_all_active_post);  
        ?>
        ...
        <?php
            ...
            $select_all_approved_comments = mysqli_query($connect,$query);
            $approved_comments = mysqli_num_rows($select_all_approved_comments);
        ...
        <?php
            ...
            $select_admin_user = mysqli_query($connect,$query);
            $admin_user_counts = mysqli_num_rows($select_admin_user);
        ...
        <?php
            ...
            $select_subs_user = mysqli_query($connect,$query);
            $subs_user_counts = mysqli_num_rows($select_subs_user);
