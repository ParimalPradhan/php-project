        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if(isset($_GET['p_id']))
                {
                    ...
                    {
                        echo "<h1 class='text-center'>No Categories to show</h1>";
                    }
                    else
                    { 
                ...
                <div class="well">
                    ...
                    <form action="#" method="post" role="form">
                        <div class="form-group">
                            ...
                            <input placeholder="Your Name" type="text" class="form-control" name="comment_author">    
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input placeholder="yourid@emailprovider.com" type="email" class="form-control" name="comment_email">    
                        </div>
                        <div class="form-group">
                            <label for="comment">Your Comment</label>
                            <textarea name="comment_content" placeholder="Word of Enlightment!" class="form-control" rows="3"></textarea>
                        </div>
